...
irmware-display/ is the dedicated ota_1 USB Display application used by
...
eference/ contains local protocol and presenter reference material only; it is
not linked into either release application.